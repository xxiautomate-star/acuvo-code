...
export async function runSession({
   ...
   */
  const budget = createBudget({ limitUsd: budgetUsd, limitIsDefault: budgetIsDefault === true });
  ...
  const offered = filterToolNames(
    policy,
    toolNames ?? toolNamesForRounds(maxRounds, { allowRun, root: executor.root, subagent: depth > 0 }),
  );
  /**
